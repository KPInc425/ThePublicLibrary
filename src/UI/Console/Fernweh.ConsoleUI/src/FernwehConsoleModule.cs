...
public class FernwehConsoleModule : Module
{
    private readonly bool _isDevelopment = false;
    private readonly List<Assembly> _assemblies = new List<Assembly>();

    public FernwehConsoleModule(bool isDevelopment, Assembly? callingAssembly = null)
    {
        ...
        var consoleAssembly = Assembly.GetAssembly(typeof(FernwehConsoleModule));

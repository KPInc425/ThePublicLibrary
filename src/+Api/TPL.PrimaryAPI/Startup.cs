...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services
            .AddTplPrimaryDbContext(connectionString);
            ...
            .AddSwaggerGen(c =>
            {
                c.SwaggerDoc(
                    "v1",
                        new OpenApiInfo
                        {
                            Title = appSettings.Endpoints.PrimaryApiName,
                            Version = appSettings.Endpoints.PrimaryApiVersion
                        });
                c.EnableAnnotations();
            });
    ...
    public void ConfigureContainer(ContainerBuilder builder)
    {
        ...
        builder.RegisterModule(new TplPrimaryApiModule(isInDevelopment));
    }

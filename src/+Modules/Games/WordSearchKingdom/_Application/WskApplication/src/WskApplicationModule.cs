...
public class WskApplicationModule : Module
{
    private readonly bool _isDevelopment = false;
    private readonly List<Assembly> _assemblies = new List<Assembly>();

    public WskApplicationModule(bool isDevelopment, Assembly? callingAssembly = null)
    {
    ...
    private void RegisterCommonDependencies(ContainerBuilder builder)
    {
        ...
        services.AddAutoMapper(typeof(GameMap).GetTypeInfo().Assembly);

namespace ModuleClientService
{
    public class KnownAccountsHttpClient : IKnownAccountsHttpClient, IKnownAccountsNotAuthedHttpClient
    {
        private HttpClient _httpClient;
        public KnownAccountsHttpClient(HttpClient httpClient)
        {
        ...
        public async Task<List<KnownAccountViewModel>> KnownAccountsList()
        {

...
public class BookSearchTests : BaseBooksTest
{
    ...
    {
        // Given I have books
        ICreateManyBooks(BookTplTestData.AllBooks);
    ...
    public void CanSearchBooksByAuthor()
    {
        ...
        var authors = AuthorTplTestData.AllAuthors;

        // Given I have books
        var books = BookTplTestData.AllBooks;
    ...
    public void CanRemoveDamagedBookCopies()
    {
        ...
        var manyCopiesMax = BookTplTestData.BookManyCopies;

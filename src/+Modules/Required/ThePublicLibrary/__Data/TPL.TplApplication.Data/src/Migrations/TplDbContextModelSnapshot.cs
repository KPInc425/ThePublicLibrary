...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TPL.TplCore.Entities.Member", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TPL.TplCore.Entities.MemberInMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TPL.TplCore.Entities.Membership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TPL.TplCore.Entities.Member", b =>
                {
                    ...
                    b.OwnsOne("TPL.TplCore.Entities.DigitalAddressVO", "Email", b1 =>
                        {
                            b1.Property<Guid>("MemberId")
                                .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("TPL.TplCore.Entities.DigitalAddressVO", "Phone", b1 =>
                        {
                            b1.Property<Guid>("MemberId")
                                .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TPL.TplCore.Entities.MemberInMembership", b =>
                {
                    b.HasOne("TPL.TplCore.Entities.Member", "Member")
                        .WithMany("MemberInMemberships")
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TPL.TplCore.Entities.Membership", "Membership")
                        .WithMany("MemberInMemberships")

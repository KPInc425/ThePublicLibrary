...
public class BookSearchTests : BaseBooksTest
{
    ...
    {
        // Given I have books
        ICreateManyBooks(BookYmiTestData.AllBooks);
    ...
    public void CanSearchBooksByAuthor()
    {
        ...
        var authors = AuthorYmiTestData.AllAuthors;

        // Given I have books
        var books = BookYmiTestData.AllBooks;
    ...
    public void CanRemoveDamagedBookCopies()
    {
        ...
        var manyCopiesMax = BookYmiTestData.BookManyCopies;

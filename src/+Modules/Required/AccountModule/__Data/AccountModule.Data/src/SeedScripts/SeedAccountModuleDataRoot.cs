...
public class SeedAccountModuleDataRoot //: IKnownAccountSeedScript
{
    ...
    public static readonly string KnownBusinessDomain = "fernweh.com";
    ...
    public async Task PopulateTestData(AccountModuleDbContext dbContext)
    {
        ...
        if (KnownBusiness == null)
        {
            ...
            KnownBusinessWebsite.AddKnownBusinessWebsiteAlias(new KnownBusinessWebsiteAlias(KnownBusinessWebsite, "local.fernweh.com", "local.fernweh.com"));
            KnownBusinessWebsite.AddKnownBusinessWebsiteAlias(new KnownBusinessWebsiteAlias(KnownBusinessWebsite, "localhost", "localhost"));
            KnownBusinessWebsite.AddKnownBusinessWebsiteAlias(new KnownBusinessWebsiteAlias(KnownBusinessWebsite, "game.fernweh.com", "game.fernweh.com"));

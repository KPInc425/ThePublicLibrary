...
namespace AccountModuleApi.FunctionalTests;
public class CustomWebApplicationFactory<TStartup> : WebApplicationFactory<Startup>
{
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        using (var scope = serviceProvider.CreateScope())
        {
            ...
            var db = serviceProvider.GetRequiredService<AccountModuleDbContext>();
        ...
        builder
            .ConfigureServices(services =>
            {
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType ==
                        typeof(DbContextOptions<AccountModuleDbContext>));
                ...
                services.AddAccountModuleInMemoryDbContext("AccountModule.db");

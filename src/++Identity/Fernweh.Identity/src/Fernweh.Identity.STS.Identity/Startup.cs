...
using Fernweh.Identity.Admin.EntityFramework.Shared.Entities.Identity;
...
using Fernweh.Identity.STS.Identity.Helpers;
using Duende.IdentityServer.Validation;
using Duende.IdentityServer.Services;

namespace Fernweh.Identity.STS.Identity
{
    public class Startup
    {
        ...
        public virtual void UseAuthentication(IApplicationBuilder app)
        {
            /* app.Use(async (ctx, next) =>
            {
                ...
                ctx.Request.Host = new HostString("fernweh.com:44310");
                
                await next();
            }); */
            /* app.Use(async (ctx, next) =>
            {
                ctx.SetIdentityServerOrigin("https://id.fernweh.com");
                await next();
            }); */

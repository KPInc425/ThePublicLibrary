...
using Fernweh.Identity.STS.Identity.Configuration;
using Fernweh.Identity.STS.Identity.Configuration.ApplicationParts;
using Fernweh.Identity.STS.Identity.Configuration.Constants;
using Fernweh.Identity.STS.Identity.Configuration.Interfaces;
using Fernweh.Identity.STS.Identity.Helpers.Localization;
            ...
            IConfiguration configuration)
        {
                ...
                /* authenticationBuilder.AddDiscord(options =>
                  {
                      ...
                      // options.SignInScheme = externalProviderConfiguration.DiscordSignInScheme;
                  }); */
            }
            ...
            if (externalProviderConfiguration.UseSteamProvider)
            {
                /* authenticationBuilder.AddSteam(options =>
                  {
                      // options.SignInScheme = externalProviderConfiguration.SteamSignInScheme;
                      options.ApplicationKey = externalProviderConfiguration.SteamApplicationKey;
                  }); */
            }
        }

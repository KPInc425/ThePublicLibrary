...
using Fernweh.Identity.Admin.Api.Configuration;
using Fernweh.Identity.Admin.Api.Configuration.Authorization;
using Fernweh.Identity.Admin.Api.ExceptionHandling;
using Fernweh.Identity.Admin.Api.Helpers;
using Fernweh.Identity.Admin.Api.Mappers;
using Fernweh.Identity.Admin.Api.Resources;
...
using Fernweh.Identity.Shared.Dtos;
using Fernweh.Identity.Shared.Dtos.Identity;

namespace Fernweh.Identity.Admin.Api
{

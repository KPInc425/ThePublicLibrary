...
public class DpfPrimaryDbContext : DbContext
{
    private readonly IMediator _mediator;
    public DpfPrimaryDbContext(DbContextOptions<DpfPrimaryDbContext> options, IMediator mediator)
        : base(options)
    {
        _mediator = mediator;
    }
    public DbSet<DpfDirectory> DpfDirectories { get; set; }
    public DbSet<DpfFile> DpfFiles { get; set; }
